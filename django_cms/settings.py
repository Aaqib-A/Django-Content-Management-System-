...
SECRET_KEY = "django-insecure-&lwip89ndt0z%euqhu1ve%f6kg-$g0bs_7qz=hp*ncmwca5p&$"
...
INSTALLED_APPS = [
    ...
    # To delete Media items automtically when model deletes | should be placed at the end
